              ...
              {cells.map((c) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => pick(c.iso)}
                    className={[
                      'relative flex h-8 items-center justify-center rounded-[8px] text-[12.5px]',
                      off
                        ? 'cursor-not-allowed text-[#C9C2C4] opacity-50'
                        : isSel
                          ? "bg-[#FEECF2] font-medium text-[#FA4D8D] shadow-[inset_2px_0_0_#FA4D8D]"
                          : c.outside
                            ? 'text-[#C9C2C4] hover:bg-[#FEF5F8]'
                            : isToday
                              ? "font-medium text-[#FA4D8D] after:absolute after:bottom-1 after:left-1/2 after:h-1 after:w-1 after:-translate-x-1/2 after:rounded-full after:bg-[#FA4D8D] after:content-[''] hover:bg-[#FEF5F8]"
                              : 'text-[#211D20] hover:bg-[#FEF5F8] hover:text-[#87002E]',
