...
const plans = [
  ...
  },
  {
    ...
    featured: false,
    commission: '10% of each booked activity + Stripe platform costs + GST',
    perks: [
      'Everything in Free',
  ...
  },
  {
    ...
    perks: [
      ...
      'Automated reminders, weekly activity availability etc',
      'Attendance tracking',
    ],
  },
  {
    ...
    perks: [
      ...
      'Featured placement',
      'Priority ranking',
      'E-mail blasts with activity availability three times a week',
      'Advanced analytics',
    ],
  },
];
