...
/**
 * Modal that opens (or reopens) the parent↔provider conversation for an
 * activity's provider and renders the live GetStream thread. Mounted from
 * the "Enquire Now" button on the activity detail page.
 */
