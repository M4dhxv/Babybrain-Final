...
export async function POST(request: Request) {
  ...
  // Ensure the calling staff member (and anyone added to the provider since
  // this channel was first created) is present even if it already existed.
