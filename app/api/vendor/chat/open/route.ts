...
export async function POST(request: Request) {
  ...
  // Member list is deduped up front (the calling staff member is already
  // part of staffIds) — a separate addMembers() call for members already in
  // the channel is rejected by Stream, which was the cause of a 500 here.
