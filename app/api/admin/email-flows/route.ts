...
const FLOWS: FlowMeta[] = [
  ...
  { type: 'provider_message_response', category: 'Provider', label: "You've got a message", description: 'A message the vendor sent got a reply.', wired: true, trigger: 'Stream chat webhook — every non-sender member of a parent↔provider (pp-*) channel who is an active provider_members row gets this type instead of provider_message.' },
